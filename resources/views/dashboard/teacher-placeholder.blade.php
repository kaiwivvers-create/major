...
<body>
    ...
    <div class="app-shell">
        @include('dashboard.partials.teacher-sidebar', ['user' => $user, 'activePage' => $activePage])
        ...
        <main class="main">
            ...
            <section class="card">
                <div class="placeholder-box">
                    <div>
                        <strong>Section scaffolded</strong>
                        <p class="muted">Core content for {{ strtolower($pageTitle) }} has not been added yet.</p>
                    </div>
                </div>
            </section>
        </main>
