...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .student-only.hidden { display: none; }
        .user-edit-actions {
            margin-top: 14px;
            display: flex;
        ...
        <div class="user-edit-modal" role="dialog" aria-modal="true" aria-labelledby="user-edit-title">
            ...
            <form id="user-edit-form" method="POST" action="">
                ...
                <div class="user-edit-grid">
                    ...
                    <div class="field">
                        <label for="edit_nis_display">NIS (Auto-generated)</label>
                        <input id="edit_nis_display" type="text" readonly disabled>
                    </div>
                    <div class="field">
                    ...
                    <div class="field student-only">
                        ...
                        <input id="edit_pkl_place_name" name="pkl_place_name" type="text">
                    </div>
                    <div class="field full student-only">
    ...
    <script>
        (() => {
            ...
            const fields = {
                ...
                nis_display: get('edit_nis_display'),
                role: get('edit_role'),
            ...
            const toggleStudentFields = (role) => {
                ...
                btn.addEventListener('click', () => {
                    ...
                    Object.keys(fields).forEach((key) => {
                        ...
                        if (key === 'password' || key === 'password_confirmation') {
                            fields[key].value = '';
                        } else if (key === 'nis_display') {
                            fields[key].value = row.nis ?? '';
                        } else {
                            fields[key].value = row[key] ?? '';
                        }
                    });

                    toggleStudentFields(String(fields.role?.value || ''));
