...
<head>
    ...
    <style>
        :root { --bg:#0f172a; --text:#e2e8f0; --muted:#94a3b8; --border:#334155; --primary:#2563eb; --accent:#38bdf8; --good:#22c55e; }
    ...
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Super admin menu">
                ...
                <a class="active" href="{{ route('dashboard.super-admin.completion') }}">All Completion Bars</a>
