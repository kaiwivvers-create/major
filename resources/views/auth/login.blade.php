...
<head>
    ...
    <title>{{ $appBranding->login_heading }} - {{ $appBranding->display_name }}</title>
...
<body class="page-drift-up">
    <header class="topbar">
        <div class="topbar-inner">
            ...
            <a href="{{ url('/') }}" class="navbar-logo" aria-label="{{ $appBranding->display_name }} logo" style="overflow:hidden; padding:0;">
                @if (!empty($appBranding->logo_url))
                    <img src="{{ $appBranding->logo_url }}" alt="{{ $appBranding->display_name }} logo" style="width:100%; height:100%; object-fit:cover; display:block;">
                @else
    ...
    <main class="login-wrap">
        <section class="login-card">
            <h1>{{ $appBranding->login_heading }}</h1>
            <p>{{ $appBranding->login_subheading }}</p>
