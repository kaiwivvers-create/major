...
<head>
    ...
    <title>{{ $appBranding->display_name }}</title>
    ...
    <style>
        ...
        * {
        ...
        html[data-theme="light"] .nav-links .is-current {
        ...
        html[data-theme="light"] .nav-links .login-btn {
            background: #f97316;
            border-color: #ea580c;
            color: #fff7ed;
        }

        html[data-theme="light"] .nav-links .login-btn:hover {
            background: #ea580c;
            border-color: #c2410c;
        ...
        html[data-theme="light"] .school-section,
        ...
        html[data-theme="light"] .school-detail-card,
        html[data-theme="light"] .company-carousel,
        html[data-theme="light"] .hero-visual {
            border-color: rgba(251, 146, 60, 0.5) !important;
            background: linear-gradient(160deg, rgba(255, 255, 255, 0.94), rgba(255, 247, 237, 0.92)) !important;
            color: #7c2d12;
        }

        html[data-theme="light"] .school-logo-card,
        html[data-theme="light"] .school-detail-card {
            background: rgba(255, 250, 244, 0.92) !important;
            border-color: rgba(251, 146, 60, 0.5) !important;
        }

        html[data-theme="light"] .school-logo-box {
            border-color: rgba(251, 146, 60, 0.62) !important;
            background: linear-gradient(160deg, rgba(255, 237, 213, 0.82), rgba(255, 247, 237, 0.95)) !important;
            color: #9a3412 !important;
        }

        html[data-theme="light"] .school-detail-card h3 {
            color: #7c2d12 !important;
        }

        html[data-theme="light"] .school-detail-card p,
        html[data-theme="light"] .school-detail-card li {
            color: #9a3412 !important;
        }

        html[data-theme="light"] .company-logo-mark {
            color: #fff7ed !important;
            border-color: rgba(251, 146, 60, 0.7) !important;
            background: linear-gradient(145deg, #f97316, #ea580c) !important;
            box-shadow: 0 14px 24px rgba(249, 115, 22, 0.28) !important;
        }

        html[data-theme="light"] .company-logo-name {
            color: #7c2d12 !important;
        }

        html[data-theme="light"] .company-dot {
            background: rgba(251, 146, 60, 0.5);
        }

        html[data-theme="light"] .company-dot.is-active {
            background: #f97316;
        }

        html[data-theme="light"] .feature-card:hover {
            border-color: rgba(249, 115, 22, 0.75);
            box-shadow: 0 18px 28px rgba(124, 45, 18, 0.22), 0 0 0 1px rgba(249, 115, 22, 0.2);
        }

        html[data-theme="light"] .feature-icon,
        html[data-theme="light"] .audience-icon {
            border-color: rgba(251, 146, 60, 0.62) !important;
            background: linear-gradient(135deg, rgba(249, 115, 22, 0.24), rgba(251, 146, 60, 0.22)) !important;
            color: #fff7ed !important;
        }

        html[data-theme="light"] .school-links a {
            color: #c2410c !important;
            border-bottom-color: rgba(249, 115, 22, 0.45) !important;
        }

        html[data-theme="light"] .school-links a:hover {
            color: #ea580c !important;
            border-bottom-color: rgba(234, 88, 12, 0.7) !important;
        }
        ...
        html[data-theme="light"] .cta a.primary {
            background: #f97316 !important;
            border-color: #ea580c !important;
            color: #fff7ed !important;
        }

        html[data-theme="light"] .cta a.secondary {
        ...
        html[data-theme="light"] .bottombar {
            ...
            border-top-color: rgba(251, 146, 60, 0.55) !important;
        }
        ...
        html[data-theme="light"] .wa-line:hover {
            border-color: #ea580c !important;
            color: #ea580c !important;
        ...
        @keyframes learn-more-pulse-light {
            0%,
            100% {
        ...
        @keyframes section-focus-glow-light {
            0% {
        ...
        html[data-theme="light"] .cta .secondary {
            animation-name: learn-more-pulse-light;
        }

        html[data-theme="light"] .section-focus {
            animation-name: section-focus-glow-light;
        }
...
<body class="page-drift-up">
    <header id="top-anchor" class="topbar">
        <div class="topbar-inner">
            <div class="topbar-left">
                <div class="brand">{{ $appBranding->display_name }}</div>
                ...
                <button type="button" class="theme-toggle-btn" id="landing-theme-toggle" aria-label="Switch theme" title="Switch theme" style="display: none;">&#9728;</button>
            </div>
            <a href="#" class="navbar-logo" aria-label="{{ $appBranding->display_name }} logo" style="overflow:hidden; padding:0;">
                @if (!empty($appBranding->logo_url))
                    <img src="{{ $appBranding->logo_url }}" alt="{{ $appBranding->display_name }} logo" style="width:100%; height:100%; object-fit:contain; object-position:center; display:block;">
                @else
                    {{ $appBranding->short_display_name }}
                @endif
            </a>
        </div>
    </header>
    ...
    <div class="page">
        ...
        <main class="hero reveal">
            <div class="hero-content">
                <div>
                    <span class="kicker">{{ $appBranding->hero_kicker }}</span>
                    <h1>{{ $appBranding->hero_heading }}</h1>
                    <p>
                        {{ $appBranding->hero_body }}
                    </p>
                ...
                <div class="hero-visual" style="overflow:hidden; padding:0;">
                    @if (!empty($appBranding->hero_image_url))
                        <img src="{{ $appBranding->hero_image_url }}" alt="{{ $appBranding->display_name }} hero image" style="width:100%; height:auto; display:block;">
                    @else
                        Image Area
                    @endif
                </div>
        ...
        <section class="stats-bar reveal" aria-label="{{ $appBranding->display_name }} statistics">
        ...
        <section id="feature-section" class="feature-section reveal" aria-labelledby="feature-title">
            <div class="feature-header">
                <h2 id="feature-title">Why {{ $appBranding->display_name }}</h2>
        ...
        @if (($landingCompanies ?? collect())->isNotEmpty())
    ...
    <script>
        (() => {
            ...
            const applyTheme = (value, persist = true) => {
                ...
                if (toggleBtn) {
                    ...
                    toggleBtn.setAttribute('title', currentTheme === 'light' ? 'Dark mode' : 'Light mode');
                }
        ...
        (() => {
            ...
            if (contactNav && schoolInfo && contact) {
                contactNav.addEventListener('click', (event) => {
                    event.preventDefault();
                    contact.scrollIntoView({ behavior: 'smooth', block: 'end' });
                    sequencePulse(companyInfo ? [schoolInfo, companyInfo, contact] : [schoolInfo, contact], 280, 680);
                });
            }
        })();
