...
<body class="page-drift-up">
    ...
    <div class="page">
        ...
        <section class="feature-section reveal" aria-labelledby="feature-title">
        ...
        <section class="school-section reveal" aria-labelledby="school-info-title">
        ...
        <section class="school-section reveal" aria-labelledby="company-info-title">
                    ...
                    <article class="company-slide" data-company-slide>
                        <div class="school-grid company-grid">
                            <div class="school-logo-card">
                                <div class="school-logo-box">
                                    <div>
                                        <div class="company-logo-mark">NB</div>
                                        <p class="company-logo-name">Nusa Byte Teknologi</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="school-detail-card">
                                <h3>Address</h3>
                                <p>Jl. Melati Raya No. 18, Tangerang Selatan, Banten 15413</p>

                                <h3 style="margin-top: 12px;">Contact Person</h3>
                                <p>PIC: +62 813-1111-1111</p>
                                <p>Email: hello@nusabyte.co.id</p>

                                <h3 style="margin-top: 12px;">Official Website</h3>
                                <ul class="school-links">
                                    <li><a href="https://www.nusabyte.co.id" target="_blank" rel="noopener noreferrer">www.nusabyte.co.id</a></li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="company-slide" data-company-slide>
                        <div class="school-grid company-grid">
                            <div class="school-logo-card">
                                <div class="school-logo-box">
                                    <div>
                                        <div class="company-logo-mark">AG</div>
                                        <p class="company-logo-name">Arunika Global Solusi</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="school-detail-card">
                                <h3>Address</h3>
                                <p>Jl. Cendana Timur No. 27, Bekasi, Jawa Barat 17113</p>

                                <h3 style="margin-top: 12px;">Contact Person</h3>
                                <p>PIC: +62 812-5454-9001</p>
                                <p>Email: contact@arunikaglobal.id</p>

                                <h3 style="margin-top: 12px;">Official Website</h3>
                                <ul class="school-links">
                                    <li><a href="https://www.arunikaglobal.id" target="_blank" rel="noopener noreferrer">www.arunikaglobal.id</a></li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="company-slide" data-company-slide>
                        <div class="school-grid company-grid">
                            <div class="school-logo-card">
                                <div class="school-logo-box">
                                    <div>
                                        <div class="company-logo-mark">SP</div>
                                        <p class="company-logo-name">Sagara Prime Industries</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="school-detail-card">
                                <h3>Address</h3>
                                <p>Jl. Kenanga Barat No. 5, Jakarta Selatan, DKI Jakarta 12940</p>

                                <h3 style="margin-top: 12px;">Contact Person</h3>
                                <p>PIC: +62 811-7272-8181</p>
                                <p>Email: hr@sagaraprime.com</p>

                                <h3 style="margin-top: 12px;">Official Website</h3>
                                <ul class="school-links">
                                    <li><a href="https://www.sagaraprime.com" target="_blank" rel="noopener noreferrer">www.sagaraprime.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="company-slide" data-company-slide>
                        <div class="school-grid company-grid">
                            <div class="school-logo-card">
                                <div class="school-logo-box">
                                    <div>
                                        <div class="company-logo-mark">VK</div>
                                        <p class="company-logo-name">Vektor Kreasi Digital</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="school-detail-card">
                                <h3>Address</h3>
                                <p>Jl. Anggrek Utama No. 44, Bandung, Jawa Barat 40115</p>

                                <h3 style="margin-top: 12px;">Contact Person</h3>
                                <p>PIC: +62 857-3300-1100</p>
                                <p>Email: info@vektorkreasi.id</p>

                                <h3 style="margin-top: 12px;">Official Website</h3>
                                <ul class="school-links">
                                    <li><a href="https://www.vektorkreasi.id" target="_blank" rel="noopener noreferrer">www.vektorkreasi.id</a></li>
                                </ul>
                            </div>
                        </div>
                    </article>
            ...
            <div class="company-dots" data-company-dots aria-hidden="true">
                <span class="company-dot is-active"></span>
    ...
    <script>
        ...
        (() => {
            ...
            if (!trigger || !audience || !how) return;
